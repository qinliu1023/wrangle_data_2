"""
Sample code form Udacity Data Analyst Nanodegree
...
When starting out, try using a larger k, then move on to an intermediate k 
before processing your whole dataset.
